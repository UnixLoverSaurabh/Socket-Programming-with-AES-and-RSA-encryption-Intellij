...
public class MessageDecryption {
    ...
    public MessageDecryption(byte[] message, Key key) {
        try {
            ...
            this.messageImage = newPlainText;
            //System.out.println(new String(newPlainText, StandardCharsets.UTF_8));
            System.out.println("It took " + duration + " nanosecond to decrypt the image " + this.messageImage);
            System.out.println("Message length is " + this.messageImage.length);
